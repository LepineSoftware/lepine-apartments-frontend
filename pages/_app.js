...
function MyApp({ Component, pageProps }) {
  ...
  return (
    ...
    >
      ...
      {/*
        Third-party scripts are loaded via next/script (NOT inside <Head>).
        HubSpot and GTM mutate <head> as they load; when they live inside
        next/head they break its next-head-count reconciliation on hydration,
        which duplicated the canonical/title/description tags. next/script
        injects them without corrupting the head next/head manages.
      */}
      <Script
        id="hs-script-loader"
      ...
      <Script id="gtm-nmd6nt3k" strategy="afterInteractive">
      ...
      <Script id="gtm-wmrthdwf" strategy="afterInteractive">
        {`(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
          new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
          j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
          'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
          })(window,document,'script','dataLayer','GTM-WMRTHDWF');`}
      </Script>
      ...
      >
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-WMRTHDWF"
            height="0"
            width="0"
            style={{ display: "none", visibility: "hidden" }}
          ></iframe>
