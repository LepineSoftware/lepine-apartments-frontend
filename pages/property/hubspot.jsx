...
import TheNormandFAQs from "../../static/property/thenormand/faqs.json";
import TheNormandListings from "../../static/property/thenormand/listings.json";
import HubSpotContact from "../../components/HubSpotContact/HubSpotContact.component";
      ...
      <Container page="propertyV2" theme={pageId}>
        ...
        {/* {contact && 
                <ContactPopup2025
                    ...
                    formId="2b77e03e-6b0b-4c82-9535-300a7cd83d08"
        ...
        <HubSpotContact
          ...
          formId="2b77e03e-6b0b-4c82-9535-300a7cd83d08"
          phone={contactInfo.phone}
          bookNowURL="https://meetings.hubspot.com/matthew1249/matthew-mark-book-now-test?embed=true"
        />
