...
const NavExternalLinks = ({
  ...
  const iconClasses = ["nav__phone--icon"];
  whiteIcon
    ? iconClasses.push("themeSVG__circle--white")
    : iconClasses.push("themeSVG__circle");

  const TenantServicesTrigger = (
    <span>
      Tenant
      <br />
      Portal
  ...
  return (
    <Fragment>
      ...
      {tenantServices && (
        <div
          className="nav__portal"
          onClick={() => submitGAEvent("tenant_portal_clicked")}
        >
          <AppPopup
            trigger={TenantServicesTrigger}
            copy={tenantServices.copy}
          />
        </div>
      )}
    </Fragment>
...
export default NavExternalLinks;
